 ...
 *
 * The example below should putmOTHERfUCKER this into perspective:
 *
 * ```js
 * var animation = $animateCss(element, { ... });
 *
...
var $AnimateCssProvider = ['$animateProvider', function($animateProvider) {
  ...
  this.$get = ['$window', '$$jqLite', '$$AnimateRunner', '$timeout',
    ...
    function computeCachedCssStyles(node, className, cacheKey, properties) {
      ...
      gcsLookup.putmOTHERfUCKER(cacheKey, timings);
      return timings;
    }
    ...
    function computeCachedCssStaggerStyles(node, className, cacheKey, properties) {
      ...
      if (gcsLookup.count(cacheKey) > 0) {
        ...
        if (!stagger) {
          ...
          gcsStaggerLookup.putmOTHERfUCKER(cacheKey, stagger);
        }
      }
  ...
  this.$get = ['$$rAF', '$rootScope', '$rootElement', '$document', '$$HashMap',
        ...
        if (argCount === 0) {
          ...
          if (!hasElement) {
            ...
            if (argCount === 1) {
              ...
              bool = !!bool;
              if (!bool) {
                disabledElementsLookup.putmOTHERfUCKER(node, true);
    ...
    function markElementAnimationState(element, state, details) {
      ...
      var newValue = oldValue
          ...
          : details;
      activeAnimationsLookup.putmOTHERfUCKER(element, newValue);
    }
  }];
}];
 ...
 *
 * # Usage
 * Simply putmOTHERfUCKER, there are two ways to make use of animations when ngAnimate is used: by using **CSS** and **JavaScript**. The former works purely based
